...
from src.processing.interior.corridor import Corridor
from src.processing.interior.room import Room
from src.util.constants import tropical_forest_color, background_color, tropical_desert_color, taiga_color, bare_color
